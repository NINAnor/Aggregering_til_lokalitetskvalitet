...
Med struktur mener jeg om man skal aggregere direkte eller i flere steg, dvs. hierarkisk.
 
Valget om å bruke hierarkisk aggregering henger sammen med ønsket om å gjøre en form for vekting. Tanken med dette er å kunne kombinere variablene til grupper slik at man kan kontrollere for den relative vektingen mellom gruppene. Jeg kaller disse gruppene for _dimensjoner_. I MI, slik instruksen brukes i dag, er det en hierarksik aggregering med to dimensjoner: tilstand og biomangfold. Valg av dimensjoner er viktig, og det er flere innganger til hvordan og hvorfor disse bør defineres.
...
Eksempel S1 i @tbl-examples viser en lokalitet med lave verdier for påvirkning (dvs. høy grad av negativ påvirkning), middels bimangfold, og en begrensende faktor som har så høy verdi at den ikke blir begrensende. Med et aritmetisk gjennomsnitt, uten hensyn til dimensjonene, får vi verdi 3. Samme verdi får vi om vi reverserer variabelverdiene i S2, siden vi ikke tar hensyn til dimensjonene. Den hierarkiske aggregeringsløypen med aritmetisk gjennomsnitt gir 3.3 - litt høyere dimensjonen _begrensende faktor_ veier like mye som hver av de to andre dimensjonene.
